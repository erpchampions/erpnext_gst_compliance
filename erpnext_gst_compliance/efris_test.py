...
def main():
    ...
    #resp_content = efris_utils.make_post("T130", seriviceUpload)
    resp_content = erpnext_gst_compliance.efris_utils.make_post("T109", invoiceUpload_Goods_NonExcise_Blanks2)
    #resp_content = efris_utils.make_post("T109", seriviceUpload)
...
invoiceUpload_Goods_NonExcise_Blanks2 = {
   "sellerDetails": {
      "tin": "1002170340",
      "ninBrn": "",
      "legalName": "ASK CORPORATE CONSULTS LTD",
...
invoiceUpload_Goods_NonExcise_Blanks = {
   "sellerDetails": {
      "tin": "1002170340",
      "ninBrn": "",
      "legalName": "ASK CORPORATE CONSULTS LTD",
...
invoiceUpload_Goods_NonExcise_BAK = {
   "sellerDetails": {
      "tin": "1002170340",
      "ninBrn": "",
      "legalName": "ASK CORPORATE CONSULTS LTD",
...
def get_test_invoice_goods_no_excise():
