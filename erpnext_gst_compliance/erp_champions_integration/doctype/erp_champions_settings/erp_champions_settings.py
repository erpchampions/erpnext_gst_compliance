...
from erpnext_gst_compliance.erp_champions_integration.erpchampions_connector import ErpChampionsConnector

class ERPChampionsSettings(Document):
	def validate(self):
		if not self.enabled:
			return
